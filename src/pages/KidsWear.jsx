...
export default function KidsWear() {
  const products = brand.products.kids

  return (
    <main>
      {/* Category Hero */}
      <section className="relative h-64 sm:h-80 flex items-end overflow-hidden">
        {/* TODO: Replace with real kids wear category image */}
        <img
          src="https://picsum.photos/seed/kids-hero/1920/640"
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 pb-10">
          <nav className="flex items-center gap-1.5 text-xs text-stone-300 mb-4" aria-label="Breadcrumb">
            ...
            <span className="text-white font-medium">Kids' Wear</span>
          </nav>
          <motion.h1
          ...
          <p className="text-stone-300 mt-2 text-sm sm:text-base">
            Colorful, durable clothing for little ones
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <SectionReveal className="mb-8 flex items-baseline justify-between">
          <div>
