...
export default function MensWear() {
  const products = brand.products.mens

  return (
    <main>
      {/* Category Hero */}
      <section className="relative h-64 sm:h-80 flex items-end overflow-hidden">
        {/* TODO: Replace with real men's wear category image */}
        <img
          src="https://picsum.photos/seed/mens-hero/1920/640"
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 pb-10">
          ...
          <p className="text-stone-300 mt-2 text-sm sm:text-base">
            Formal, casual & ethnic wear for every man
          </p>
        </div>
      </section>
